package com.axial.archive_backend.config;

import com.axial.archive_backend.util.AppConstants;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    MessageSource messageSource() {
        ...
        bean.setBasename("classpath:ArchiveBackendMessages");
    ...
    public LocaleChangeInterceptor localeChangeInterceptor() {
        ...
        //lci.setParamName(ApplicationHeader.ACCEPT_LANGUAGE.getKey());
